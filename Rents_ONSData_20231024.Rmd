---
title: "Housing analysis, October 24th 2023"
output: 
  html_document:
    css: Wil_style.css
    theme: default
...
Rentals_Regions_Data <- read.csv("C:/Families/Data/Housing/ONS_Rents_Regions_all.csv") %>%  
 data.frame()

Rentals_Boroughs_Data <- read.csv("C:/Families/Data/Housing/ONS_Rents_LAs_all.csv") %>%  
 data.frame()
